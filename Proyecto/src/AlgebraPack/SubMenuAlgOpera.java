package AlgebraPack;//Menu de algebra

import AppMainSrc.Button;
import javax.swing.*;
import java.awt.*;

public class SubMenuAlgOpera extends JPanel{
    
    public GaussJordan gaussJordan = new GaussJordan();

    public DetCalculator detCalculator = new DetCalculator();
    
    public OperaMatrices operaMatrices = new OperaMatrices();
