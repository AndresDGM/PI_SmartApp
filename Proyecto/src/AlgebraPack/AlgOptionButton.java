...
public class AlgOptionButton extends JPanel {
    ...
    public void accionMouse(){
        MouseListener m = new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                switch (valor){
                    case 2:
                        changeCoordsMat(250, 180, 240, 238, 118);
                        changeCoordsText(200, 280, 238);
                        ...
                        break;
                    case 3:
                        changeCoordsMat(250, 120, 250, 160, 98);
                        changeCoordsText(200, 280, 160);
                        g.getWarning().setLocation(237, 145);
                        g.getBorde().setW(720);
                        g.getBorde().setH(450);
                        g.getBorde().setLocation(177, 173);
                        ...
                        break;
                    case 4:
                        changeCoordsMat(218, 108, 237, 128, 88);
                        changeCoordsText(174, 262, 128);
                        ...
                        break;
                    case 5:
                        changeCoordsMat(195, 100, 228, 108, 78);
                        changeCoordsText(143, 248, 108);
    ...
    public void changeCoordsMat(int y, int yIncrement, int x, int xIntcrement, int s){
    ...
    public void changeCoordsText(int y, int x, int xIntcrement){
        for (int i = 0; i < 5; i++){
